  ...
  header: {
    ...
    actions: {
      ...
      infoJson: {
        label: '素材草稿',
        title: 'Sidecar Draft',
        ariaLabel: '開啟本地 sidecar 草稿工具',
      },
    },
  },
  infoJson: {
    title: '整理本地 sidecar 草稿',
    subtitle: '把流程拆成三個分頁，分別整理影片資訊、字幕資訊與影片處理設定。每個分頁都能獨立完成，方便逐步準備 sidecar 與後端送件草稿。',
    panels: {
      metadata: {
        title: '影片資訊',
        caption: '整理影片 metadata，完成後可直接下載 info.json。',
      },
      subtitles: {
        title: '字幕資訊',
        caption: '匯入本地字幕並檢查 manifest，完成後可下載 subtitles.json。',
      },
      video: {
        title: '影片處理',
        caption: '選取來源影片、勾選轉檔解析度，並決定是否一併帶上 sidecar JSON。',
      },
    },
    tabs: {
    ...
    assets: {
      ...
      subtitles: {
        title: '字幕',
        caption: '可匯入多個 .vtt / .srt，會同步生成 subtitles.json 草稿。',
        empty: '尚未匯入字幕',
        count: '共 {count} 條字幕',
      ...
      video: {
        title: '來源影片',
        caption: '先選取本地影片檔，供後續串接後端影片處理器。',
        empty: '尚未選取影片',
        draftTitle: '影片處理草稿',
        draftCaption: '目前只建立本地草稿，不會真的上傳。',
        pending: '待串接處理器',
        ready: '已建立本地草稿',
      },
    },
    manifests: {
      infoTitle: 'info.json 預覽',
      infoCaption: '這份內容會直接作為 sidecar 目錄中的 info.json。',
      infoEmpty: '填寫影片資訊後，這裡會生成 info.json。',
      subtitlesTitle: 'subtitles.json 預覽',
      subtitlesCaption: '根據目前匯入的本地字幕生成。',
      subtitlesEmpty: '匯入字幕後，這裡會自動生成 subtitles.json。',
    },
    preview: {
    ...
    status: {
      ready: '目前整理了 {info} 個 metadata 欄位、{subtitles} 條字幕與 {assets} 份本地素材',
      infoCopied: '已複製 info.json',
    ...
    video: {
      ...
      resolutionsCaption: '先決定希望後端處理器輸出的畫質組合。',
      selectedResolutions: '已選 {count} 個解析度',
      noResolutionSelected: '請至少勾選一個解析度',
      resolutionsHint: '實際可轉出的解析度仍會由後端依原始影片高度判斷。',
      attachmentsTitle: '一併帶給後端',
      attachmentsCaption: '決定送影片時，是否同時附上目前已整理好的 sidecar JSON。',
      ...
      draftTitle: '後端送件草稿',
      draftCaption: '目前只建立本地 request payload 預覽，尚未真的送出。',
