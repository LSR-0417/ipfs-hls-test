...
describe('VideoPlayer custom control layer contract', () => {
  it('renders a custom player control layer while hiding the user-visible video.js chrome', () => {
    const descriptor = readDescriptor(new URL('./VideoPlayer.vue', import.meta.url));
    const template = descriptor.template?.content || '';
    const script = descriptor.scriptSetup?.content || '';
    const style = getFirstStyleContent(descriptor);

    expect(template).toContain('data-testid="video-player-controls"');
    expect(template).toContain('data-testid="video-player-big-play-button"');
    expect(template).toContain('data-testid="video-player-progress-slider"');
    expect(template).toContain('data-testid="video-player-play-toggle"');
    expect(template).toContain('data-testid="video-player-mute-toggle"');
    expect(template).toContain('data-testid="video-player-volume-slider"');
    expect(template).toContain('data-testid="video-player-volume-inline"');
    expect(template).toContain('data-testid="video-player-transport-group"');
    expect(template).toContain('data-testid="video-player-volume-control"');
    expect(template).toContain('data-testid="video-player-secondary-actions"');
    expect(template).toContain('data-testid="video-player-settings-trigger"');
    expect(template).toContain('data-testid="video-player-settings-panel"');
    expect(template).toContain('data-testid="video-player-time-display"');
    expect(template).toContain('data-testid="video-player-subtitle-toggle"');
    expect(template).toContain('data-testid="video-player-primary-subtitle-trigger"');
    expect(template).toContain('data-testid="video-player-dual-subtitle-swap"');
    expect(template).toContain('data-testid="video-player-quality-trigger"');
    expect(template).toContain('data-testid="video-player-picture-in-picture-toggle"');
    expect(template).toContain('data-testid="video-player-fullscreen-toggle"');
    expect(template).toContain('data-testid="video-player-quality-menu"');
    expect(template).toContain('data-testid="video-player-quality-option-auto"');
    expect(template).toContain('class="player-control-stack"');
    expect(template).toContain(':class="playerShellClasses"');
    expect(template).toContain(":class=\"{ 'player-control-layer--idle': isControlBarHidden }\"");
    expect(template).toContain(':data-controls-visible="isControlBarHidden ? \'false\' : \'true\'"');
    expect(template).toContain("'is-hidden': isControlBarHidden");
    expect(template).toContain("'player-control-bar--fullscreen': isPlayerFullscreen");

    expect(script).toContain('const isControlSurfaceReady = ref(false);');
    expect(script).toContain('const compactSettingsTriggerRef = ref(null);');
    expect(script).toContain('const compactSettingsPanelRef = ref(null);');
    expect(script).toContain('const isCompactSettingsOpen = ref(false);');
    expect(script).toContain('const isPlayerUserActive = ref(true);');
    expect(script).toContain('const isControlBarHovered = ref(false);');
    expect(script).toContain('const playerControlSafeAreaPx = ref(88);');
    expect(script).toContain('const playerShellWidth = ref(0);');
    expect(script).toContain('const isPictureInPictureSupported = ref(false);');
    expect(script).toContain('const availableQualityLevels = ref([]);');
    expect(script).toContain('const isCompactPhoneViewport = computed(');
    expect(script).toContain('const playerShellStyle = computed(() => ({');
    expect(script).toContain('const isControlLayerPinnedOpen = computed(');
    expect(script).toContain('const isCustomControlLayerVisible = computed(() =>');
    expect(script).toContain('const isControlBarHidden = computed(');
    expect(script).toContain('const playerShellClasses = computed(() => ({');
    expect(script).toContain('const volumeMuteTooltip = computed(() =>');
    expect(script).toContain('const volumeStatusLabel = computed(() =>');
    expect(script).toContain('const volumeSliderAriaLabel = computed(() =>');
    expect(script).toContain('const qualityControlState = computed(() => {');
    expect(script).toContain('function updatePlayerShellWidth() {');
    expect(script).toContain('function updatePlayerControlSafeArea() {');
    expect(script).toContain('function resolvePlayerFullscreenState() {');
    expect(script).toContain('function bindDocumentFullscreenListeners() {');
    expect(script).toContain('function toggleCompactSettings() {');
    expect(script).toContain('function wakeControlSurface() {');
    expect(script).toContain('function handlePlayerUserActive() {');
    expect(script).toContain('function handlePlayerUserInactive() {');
    expect(script).toContain('function handlePlayerShellActivity(event) {');
    expect(script).toContain('function hideControlSurface() {');
    expect(script).toContain('function handlePlayerShellPointerLeave(event) {');
    expect(script).toContain('function handleControlBarPointerEnter() {');
    expect(script).toContain('function handleControlBarPointerLeave() {');
    expect(script).toContain('function bindPlayerShellActivityListeners() {');
    expect(script).toContain('function unbindPlayerShellActivityListeners() {');
    expect(script).toContain('function bindControlSurfaceListeners() {');
    expect(script).toContain('function togglePlayback() {');
    expect(script).toContain('function toggleMute() {');
    expect(script).toContain('function handleProgressInput(event) {');
    expect(script).toContain('function togglePictureInPicture() {');
    expect(script).toContain('function toggleFullscreen() {');
    expect(script).toContain('function selectQualityLevel(targetHeight) {');
    expect(script).toContain('function getQualityOptionTestId(level) {');
    expect(script).toContain('onToggleFullscreen: toggleFullscreen,');

    expect(style).toContain('.player-control-layer');
    expect(style).toContain('.player-control-layer--idle');
    expect(style).toContain('.player-big-play-button');
    expect(style).toContain('.player-control-bar');
    expect(style).toContain('.player-control-bar--fullscreen');
    expect(style).toContain('.player-control-bar.is-hidden');
    expect(style).toContain('.player-control-stack');
    expect(style).toContain('.player-control-stack--fullscreen');
    expect(style).toContain('.player-control-group--transport');
    expect(style).toContain('.player-control-group--actions');
    expect(style).toContain('.player-control-row--compact');
    expect(style).toContain('.player-progress-control');
    expect(style).toContain('.player-progress-control--rail');
    expect(style).toContain('.player-progress-slider');
    expect(style).toContain('.player-volume-inline');
    expect(style).toContain('.player-volume-inline--hover-reveal');
    expect(style).toContain('.player-volume-control--inline');
    expect(style).toContain('.player-volume-slider');
    expect(style).toContain('--player-control-safe-area');
    expect(style).toContain('.video-player-shell :deep(.vjs-text-track-display)');
    expect(style).toContain('.player-action-btn');
    expect(style).toContain('.player-action-glyph');
    expect(style).toContain('.player-action-btn--volume');
    expect(style).toContain('.player-action-btn--settings');
