...
describe('VideoPlayer hotkey contract', () => {
  it('keeps the expanded shortcut map and the help dialog in the player template', () => {
    ...
    expect(script).toContain("label: '截圖存檔'");
    ...
    expect(script).toContain('onCaptureScreenshot: captureAndDownloadScreenshot');
...
describe('VideoPlayer playback persistence contract', () => {
  it('emits player-driven playback snapshots on key lifecycle events', () => {
    ...
    expect(script).toContain("const screenshotCaptureButtonComponentName = 'ScreenshotCaptureButton';");
    expect(script).toContain("const screenshotCaptureTitle = '截圖存檔';");
    expect(script).toContain('function createScreenshotGlyph(documentLike) {');
    expect(script).toContain('function registerScreenshotCaptureButton() {');
    expect(script).toContain('function ensureScreenshotCaptureControl() {');
    expect(script).toContain('function updateScreenshotCaptureControl() {');
    expect(script).toContain('function resolveScreenshotCaptureErrorMessage(error) {');
    expect(script).toContain('async function captureAndDownloadScreenshot() {');
    expect(script).toContain('player.screenshotCaptureAction_ = captureAndDownloadScreenshot;');
    expect(script).toContain('player.screenshotCaptureState_ = resolveScreenshotCaptureControlState();');
    expect(script).toContain("from '../utils/screenshot';");
    ...
    expect(style).toContain('.vjs-screenshot-capture-button');
    expect(style).toContain('.vjs-screenshot-capture-glyph-body');
    expect(style).toContain('.vjs-screenshot-capture-glyph-lens');
    expect(style).toContain('.vjs-screenshot-capture-glyph-flash');
